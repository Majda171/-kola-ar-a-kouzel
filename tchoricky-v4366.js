(()=>{
 ...
 const boardImg=new Image();boardImg.src='img/tchoricky-deska-v4366.webp';
 ...
 function drawBoard(){
   ctx.clearRect(0,0,W,H);ctx.fillStyle='#080a08';ctx.fillRect(0,0,W,H);
   if(boardImg.complete&&boardImg.naturalWidth)ctx.drawImage(boardImg,120,0,760,760);
   else{ctx.beginPath();ctx.arc(arena.x,arena.y,arena.r,0,Math.PI*2);ctx.fillStyle='#30302c';ctx.fill()}
 }
